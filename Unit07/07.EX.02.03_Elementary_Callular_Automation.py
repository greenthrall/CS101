...
def cellular_automaton(string, pattern, generation):
    ...
    while j < generation:
        ...
        while v_index < v_len:
            v_match = []
            v_match.append(v_string[v_index - 1])
            v_match.append(v_string[v_index])
            if v_index == v_len - 1:
                v_match.append(v_string[0])
            else:
                v_match.append(v_string[v_index + 1])
            k = 0
            while k <= 7:
                if v_match == init_pattern[(2 ** k)]:
                    v_result += new_pattern[2 ** k][1]
                    break
                k += 1
            v_index += 1
        v_string = v_result
...
def new_cellular_automation(string,pattern_number, generations):
    patterns= {}
...
print cellular_automaton('.x.x.x.x.', 17, 6)
print new_cellular_automation('.x.x.x.x.', 17, 6)
#>>> xxxxxxx..
print cellular_automaton('.x.x.x.x.', 249, 3)
print new_cellular_automation('.x.x.x.x.', 249, 3)
#>>> .x..x.x.x
print cellular_automaton('...x....', 125, 1)
print new_cellular_automation('...x....', 125, 1)
#>>> xx.xxxxx
print cellular_automaton('...x....', 125, 2)
print new_cellular_automation('...x....', 125, 2)
#>>> .xxx....
print cellular_automaton('...x....', 125, 3)
print new_cellular_automation('...x....', 125, 3)
#>>> .x.xxxxx
print cellular_automaton('...x....', 125, 4)
print new_cellular_automation('...x....', 125, 4)
#>>> xxxx...x
print cellular_automaton('...x....', 125, 5)
print new_cellular_automation('...x....', 125, 5)
#>>> ...xxx.x
print cellular_automaton('...x....', 125, 6)
print new_cellular_automation('...x....', 125, 6)
#>>> xx.x.xxx
print cellular_automaton('...x....', 125, 7)
print new_cellular_automation('...x....', 125, 7)
#>>> .xxxxx..
print cellular_automaton('...x....', 125, 8)
print new_cellular_automation('...x....', 125, 8)
#>>> .x...xxx
print cellular_automaton('...x....', 125, 9)
print new_cellular_automation('...x....', 125, 9)
#>>> xxxx.x.x
print cellular_automaton('...x....', 125, 10)
print new_cellular_automation('...x....', 125, 10)
#>>> ...xxxxx
