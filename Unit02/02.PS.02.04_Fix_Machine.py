...
def fix_machine(debris, product):
    i = 0
    while i < len(product):
        if debris.find(product[i]) == False:
...
def new_fix_machine(debris, product):
    return product if all(i in debris for i in product) else "Give me something that's not useless next time."
...
print "Test case 1: ", new_fix_machine('UdaciousUdacitee', 'Udacity') == "Give me something that's not useless next time."
print "Test case 2: ", new_fix_machine('buy me dat Unicorn', 'Udacity') == 'Udacity'
print "Test case 3: ", new_fix_machine('AEIOU and sometimes y... c', 'Udacity') == 'Udacity'
print "Test case 4: ", new_fix_machine('wsx0-=mttrhix', 't-shirt') == 't-shirt'
