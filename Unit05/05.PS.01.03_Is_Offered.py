...
def is_offered(courses,course,hexamester):
    for v_courses in courses[hexamester]:
        if course in v_courses:
            return True
    return False


def new_is_offered(courses,course,hexamester):
    return course in courses[hexamester]


print is_offered(courses, 'cs101', 'apr2012')
print new_is_offered(courses, 'cs101', 'apr2012')
#>>> True
print is_offered(courses, 'cs003', 'apr2012')
print new_is_offered(courses, 'cs003', 'apr2012')
#>>> False
print is_offered(courses, 'cs001', 'jan2044')
print new_is_offered(courses, 'cs001', 'jan2044')
#>>> True
print is_offered(courses, 'cs253', 'feb2012')
print new_is_offered(courses, 'cs253', 'feb2012')
#>>> False
