...
def involved(courses,person):
    v_result = {}
    for v_hex in courses:
        for v_course in courses[v_hex]:
            for v_type in courses[v_hex][v_course]:
                if person == courses[v_hex][v_course][v_type]:
                    if v_hex in v_result:
                        v_result[v_hex].append(v_course)
                    else:
                        v_result[v_hex] = [v_course]
    return v_result
