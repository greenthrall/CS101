...
def hashtable_lookup(htable, key):
    for v_key in hashtable_get_bucket(htable, key):
        if v_key[0] == key:
            return v_key[1]
    return None


def new_hashtable_lookup(htable, key):
...
print new_hashtable_lookup(table, 'Francis')
#>>> 13
print hashtable_lookup(table, 'Louis')
print new_hashtable_lookup(table, 'Louis')
#>>> 29
print hashtable_lookup(table, 'Zoe')
print new_hashtable_lookup(table, 'Zoe')
#>>> 14
