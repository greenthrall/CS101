...
def rabbits(n):
    v_cur = 0
    v_nex = 1
    v_die5, v_die4, v_die3, v_die2, v_die1 = 0, 0, 0, 0, 0
    for i in range(0,n):
        v_die5, v_die4, v_die3, v_die2, v_die1 = v_die4, v_die3, v_die2, v_die1, v_nex
        v_cur, v_nex = v_nex, v_cur + v_nex - v_die5
    return v_cur
...
def recur_rabbits(n):
    if n < 1:
        ...
        if n == 1 or n == 2:
            ...
            return recur_rabbits(n - 1) + recur_rabbits(n - 2) - recur_rabbits(n - 5)
